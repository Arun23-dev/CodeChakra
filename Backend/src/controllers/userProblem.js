...
const  getProblemById=async(req,res)=>{
    ...
    const fetchedProblem=await problem.findById(id).select('_id title description difficultyLevel tags visibleTestCases starterCode');
...
const getAllProblem=async(req,res)=>{
    ...
    try{
        ...
        const fetchedProblem =await problem.find({}).skip(offset).limit(limit).select('_id title difficultyLevel tags')
...
module.exports={problemCreate,problemUpdate,problemDelete,getProblemById,getAllProblem,getAllProblemSolvedByUser}
